...
var _elm_lang$elm_architecture_tutorial$Types$encodeBlock = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'tempo',
				_1: _elm_lang$core$Json_Encode$int(record.tempo)
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$int, record.accents))
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'count',
						_1: A2(_elm_lang$elm_architecture_tutorial$Types$maybeEncode, _elm_lang$core$Json_Encode$int, record.count)
					},
					_1: {ctor: '[]'}
				}
			}
...
var _elm_lang$elm_architecture_tutorial$Types$encodeSong = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'track',
				_1: _elm_lang$core$Json_Encode$string(record.track)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'artist',
					_1: _elm_lang$core$Json_Encode$string(record.artist)
				},
				_1: {
					ctor: '::',
					_0: {
...
var _elm_lang$elm_architecture_tutorial$Types$Block = F3(
	function (a, b, c) {
		return {tempo: a, accents: b, count: c};
	});
var _elm_lang$elm_architecture_tutorial$Types$decodeBlock = A4(
	_elm_lang$core$Json_Decode$map3,
	_elm_lang$elm_architecture_tutorial$Types$Block,
	A2(_elm_lang$core$Json_Decode$field, 'tempo', _elm_lang$core$Json_Decode$int),
	A2(
...
var _elm_lang$elm_architecture_tutorial$Metronome$click = _elm_lang$core$Native_Platform.outgoingPort(
	'click',
	function (v) {
		return v;
	});
var _elm_lang$elm_architecture_tutorial$Metronome$Model = F2(
	function (a, b) {
		return {block: a, status: b};
	});
var _elm_lang$elm_architecture_tutorial$Metronome$Idle = {ctor: 'Idle'};
var _elm_lang$elm_architecture_tutorial$Metronome$initialModel = function (block) {
	return {block: block, status: _elm_lang$elm_architecture_tutorial$Metronome$Idle};
};
var _elm_lang$elm_architecture_tutorial$Metronome$init = _Fresheyeball$elm_return$Return$singleton(
	A2(_elm_lang$elm_architecture_tutorial$Metronome$Model, _elm_lang$elm_architecture_tutorial$Metronome$block, _elm_lang$elm_architecture_tutorial$Metronome$Idle));
var _elm_lang$elm_architecture_tutorial$Metronome$Counting = F2(
	function (a, b) {
		return {ctor: 'Counting', _0: a, _1: b};
	});
var _elm_lang$elm_architecture_tutorial$Metronome$Stop = {ctor: 'Stop'};
var _elm_lang$elm_architecture_tutorial$Metronome$Start = {ctor: 'Start'};
var _elm_lang$elm_architecture_tutorial$Metronome$view = function (model) {
	return A2(
						...
						_elm_lang$html$Html$button,
						{
							...
							_0: function () {
								...
								if (_p5.ctor === 'Idle') {
									...
									return _elm_lang$html$Html_Events$onClick(_elm_lang$elm_architecture_tutorial$Metronome$Stop);
								}
							}(),
							_1: {ctor: '[]'}
						},
						{
							...
							_0: function () {
								...
								if (_p6.ctor === 'Idle') {
									...
									return _elm_lang$html$Html$text('Stop');
								}
							}(),
							_1: {ctor: '[]'}
						}),
...
var _elm_lang$elm_architecture_tutorial$Metronome$subscriptions = function (model) {
	...
	if (_p7.ctor === 'Counting') {
		return A2(
			_elm_lang$core$Time$every,
			_elm_lang$elm_architecture_tutorial$Metronome$tempoToMs(model.block.tempo),
			_elm_lang$core$Basics$always(_elm_lang$elm_architecture_tutorial$Metronome$Tick));
	} else {
		return _elm_lang$core$Platform_Sub$none;
	}
};
var _elm_lang$elm_architecture_tutorial$Metronome$Low = {ctor: 'Low'};
var _elm_lang$elm_architecture_tutorial$Metronome$High = {ctor: 'High'};
		...
		switch (_p8.ctor) {
			case 'Tick':
				...
				if (_p9.ctor === 'Idle') {
					...
					if (_p10.ctor === 'Just') {
						var _p12 = _p10._0;
						if (_elm_lang$core$Native_Utils.cmp(_p12, 0) < 1) {
							return _Fresheyeball$elm_return$Return$singleton(
								_elm_lang$core$Native_Utils.update(
									model,
									{status: _elm_lang$elm_architecture_tutorial$Metronome$Idle}));
						} else {
							var _p11 = _elm_lang$elm_architecture_tutorial$Metronome$stripList(_p14);
								...
								return A2(
									...
									_Fresheyeball$elm_return$Return$singleton(
										_elm_lang$core$Native_Utils.update(
											...
											{
												status: A2(
													_elm_lang$elm_architecture_tutorial$Metronome$Counting,
													model.block.accents,
													_elm_lang$core$Maybe$Just(_p12 - 1))
											})));
							} else {
								return A2(
									_Fresheyeball$elm_return$Return$command,
						...
						var _p13 = _elm_lang$elm_architecture_tutorial$Metronome$stripList(_p14);
							...
							return A2(
								...
								_Fresheyeball$elm_return$Return$singleton(
									_elm_lang$core$Native_Utils.update(
										model,
										{
											status: A2(_elm_lang$elm_architecture_tutorial$Metronome$Counting, model.block.accents, _elm_lang$core$Maybe$Nothing)
										})));
						} else {
							return A2(
								_Fresheyeball$elm_return$Return$command,
								...
								_Fresheyeball$elm_return$Return$singleton(
									_elm_lang$core$Native_Utils.update(
										model,
										{
											status: A2(_elm_lang$elm_architecture_tutorial$Metronome$Counting, _p13._1._0, _elm_lang$core$Maybe$Nothing)
										})));
						}
					}
				}
			case 'Start':
				return A2(
					_Fresheyeball$elm_return$Return$command,
					_elm_lang$elm_architecture_tutorial$Metronome$click(
						_elm_lang$core$Basics$toString(_elm_lang$elm_architecture_tutorial$Metronome$High)),
					_Fresheyeball$elm_return$Return$singleton(
						_elm_lang$core$Native_Utils.update(
							model,
							{
								status: A2(_elm_lang$elm_architecture_tutorial$Metronome$Counting, model.block.accents, model.block.count)
							})));
			default:
				return _Fresheyeball$elm_return$Return$singleton(
					_elm_lang$core$Native_Utils.update(
...
var _elm_lang$elm_architecture_tutorial$Metronome$main = _elm_lang$html$Html$program(
	{init: _elm_lang$elm_architecture_tutorial$Metronome$init, view: _elm_lang$elm_architecture_tutorial$Metronome$view, update: _elm_lang$elm_architecture_tutorial$Metronome$update, subscriptions: _elm_lang$elm_architecture_tutorial$Metronome$subscriptions})();

var Elm = {};
Elm['Metronome'] = Elm['Metronome'] || {};
if (typeof _elm_lang$elm_architecture_tutorial$Metronome$main !== 'undefined') {
    _elm_lang$elm_architecture_tutorial$Metronome$main(Elm['Metronome'], 'Metronome', undefined);
}
